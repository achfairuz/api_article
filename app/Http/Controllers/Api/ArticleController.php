...
class ArticleController extends BaseController
{
    ...
    public function showALL(Request $request)
    {
        ...
        $articles = Article::where('category', 'Keperawatan')->where("user_id", 1)->with("author")->get();
    ...
    public function detailById(Request $request)
    {
        ...
        $article = Article::where('category', 'Keperawatan')->where("id", $request->id)->with("author")->get()->first();
